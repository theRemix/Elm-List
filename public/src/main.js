...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var main = A2($Html.ul,
   _U.list([$Html$Attributes.$class("grocery-list")]),
   _U.list([A2($Html.li,
           _U.list([]),
           _U.list([$Html.text("Pamplemousse")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("Ananas")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("Jus d\'orange")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("Boeuf")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("Soupe du jour")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("Camembert")]))
           ,A2($Html.li,
           _U.list([]),
           _U.list([$Html.text("Jacques Cousteau")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("Baguette")]))]));
